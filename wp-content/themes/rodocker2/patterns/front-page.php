...
<h1 class="wp-block-heading has-text-align-center has-x-large-font-size">Words commitment to innovation and sustainability</h1>
<!-- /wp:heading -->
...
<figure class="wp-block-image alignwide size-full is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/building-exterior.webp" alt="<?php echo esc_attr_e( 'Building exterior in Toronto, Canada', 'Twenty Twenty-Four' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading is-style-asterisk">Jizz App</h3>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-large is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/tourist-and-building.webp" alt="<?php echo esc_attr_e( 'Tourist taking photo of a building', 'Twenty Twenty-Four' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
<figure class="wp-block-image size-large is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/windows.webp" alt="<?php echo esc_attr_e( 'Windows of a building in Nuremberg, Germany', 'Twenty Twenty-Four' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"40%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%"><!-- wp:heading {"level":3,"className":"is-style-asterisk"} -->
<h3 class="wp-block-heading is-style-asterisk">Cock Newsletter</h3>
<!-- /wp:heading -->
